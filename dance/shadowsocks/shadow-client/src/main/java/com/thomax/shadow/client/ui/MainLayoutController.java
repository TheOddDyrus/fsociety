package com.thomax.shadow.client.ui;

import com.thomax.shadow.client.config.Constant;
import com.thomax.shadow.client.ShadowClientGui;
...
import com.thomax.shadow.client.network.NioLocalServer;
...
public class MainLayoutController {
    ...
    private void initialize() {
        ...
        // set proxy options
        ObservableList<TYPE> proxyTypes = FXCollections.observableArrayList();
        ...
        try {
            FXMLLoader logLayoutLoader = new FXMLLoader(ShadowClientGui.class.getResource("/resources/ui/LogLayout.fxml"));
            ...
            stage.getIcons().add(new Image(ShadowClientGui.class.getResource("/resources/image/icon.png").toString()));
    ...
    private void handleStart() {
        ...
        do {
            ...
            TYPE type = (TYPE) cboProxyType.getValue();
    ...
    public void setMainGui(ShadowClientGui gui) {
        this.gui = gui;
    }
